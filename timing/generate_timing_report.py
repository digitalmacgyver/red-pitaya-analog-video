...
def parse_timing_csv(filepath: str, label: str = None) -> TimingData:
    """
...
def create_histogram_comparison(data1: TimingData, data2: TimingData,
                                output_path: str, timing_type: str = 'horizontal') -> str:
...
def generate_html_report(data1: TimingData, data2: TimingData,
    ...
    if HAS_MATPLOTLIB:
        ...
        create_field_stability_plot(data1, data2, img_path)
...
<body>
    ...
    <table>
        ...
        <tr>
            <td>Std Dev</td>
            <td>{stats1_h.std*1e9:.2f} ns</td>
            <td>{stats2_h.std*1e9:.2f} ns</td>
            <td>—</td>
        </tr>
        <tr>
            <td>RMS Jitter</td>
            <td>{stats1_h.rms_jitter*1e9:.2f} ns</td>
            <td>{stats2_h.rms_jitter*1e9:.2f} ns</td>
            <td>—</td>
        </tr>
        <tr>
            <td>Peak-to-Peak Jitter</td>
            <td>{stats1_h.pp_jitter*1e9:.2f} ns</td>
            <td>{stats2_h.pp_jitter*1e9:.2f} ns</td>
            <td>—</td>
        </tr>
        <tr>
            <td>Min</td>
    ...
    <table>
        ...
        <tr>
            <td>Std Dev</td>
            <td>{stats1_v.std*1e6:.2f} µs</td>
            <td>{stats2_v.std*1e6:.2f} µs</td>
            <td>—</td>
        </tr>
        <tr>
            <td>RMS Jitter</td>
            <td>{stats1_v.rms_jitter*1e6:.2f} µs</td>
            <td>{stats2_v.rms_jitter*1e6:.2f} µs</td>
            <td>—</td>
        </tr>
        <tr>
            <td>Peak-to-Peak Jitter</td>
            <td>{stats1_v.pp_jitter*1e6:.2f} µs</td>
            <td>{stats2_v.pp_jitter*1e6:.2f} µs</td>
            <td>—</td>
        </tr>
        <tr>
            <td>Min</td>
    ...
    <p><em>Jitter values below ~{1000.0/sample_rate_mhz*2:.0f} ns may be dominated by measurement quantization rather than actual source jitter.</em></p>
